            ...
            <div class="container">
                ...
                <div id="menu-list">
                    <ul class="nav-list">
                        ...
                        <li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Pra Start Up <i
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <ul class="vertical-menu">
                                                <li><a href="#"><i class="ion-ios-circle-outline"></i> Mega menu is a
                                                        new feature</a></li>
                                                <li><a href="#"><i class="ion-ios-circle-outline"></i> This is an
                                                        example</a></li>
                                                <li><a href="#"><i class="ion-ios-circle-outline"></i> For a submenu
                                                        item</a></li>
                                                <li><a href="#"><i class="ion-ios-circle-outline"></i> You can add</a>
                                                </li>
                                                <li><a href="#"><i class="ion-ios-circle-outline"></i> Your own
                                                        items</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-9">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="inner">
                                                        <figure>
                                                            <a href="{{route('single','none')}}">
                                                                <img src="{{asset('assets/images/news/img10.jpg')}}"
                                                                    alt="Sample Article">
                                                            </a>
                                                        </figure>
                                                        <div class="padding">
                                                            <div class="detail">
                                                                ...
                                                                <div class="category"><a
                                                                        href="category.html">Healthy</a></div>
                                                            </div>
                                                            <h2><a href="{{route('single','none')}}">Duis aute irure
                                                                    dolor in reprehenderit in voluptate</a></h2>
                                                        </div>
                                                    </div>
                                                </article>
                                                <article class="article col-md-4 mini">
                                                    <div class="inner">
                                                        <figure>
                                                            <a href="{{route('single','none')}}">
                                                                <img src="{{asset('assets/images/news/img11.jpg')}}"
                                                                    alt="Sample Article">
                                                            </a>
                                                        </figure>
                                                        <div class="padding">
                                                            <div class="detail">
                                                                ...
                                                                <div class="category"><a
                                                                        href="category.html">Lifestyle</a></div>
                                                            </div>
                                                            <h2><a href="{{route('single','none')}}">Duis aute irure
                                                                    dolor in reprehenderit in voluptate</a></h2>
                                                        </div>
                                                ...
                                                <article class="article col-md-4 mini">
                                                    <div class="inner">
                                                        <figure>
                                                            <a href="{{route('single','none')}}">
                                                                <img src="{{asset('assets/images/news/img14.jpg')}}"
                                                                    alt="Sample Article">
                                                            </a>
                                                        </figure>
                                                        <div class="padding">
                        ...
                        <li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Start Up <i
                                    class="ion-ios-arrow-right"></i>
                                <div class="badge">Hot</div>
                            </a>
                            <div class="dropdown-menu megamenu">
                        ...
                        <li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Scale Up <i
                                    class="ion-ios-arrow-right"></i>
                                <div class="badge">Hot</div>
                            </a>
                            <div class="dropdown-menu megamenu">
                        ...
                        <li class="dropdown magz-dropdown"><a href="#">How to Join <i
                                    class="ion-ios-arrow-right"></i></a>
                            <ul class="dropdown-menu">
                        ...
                        @guest
                        <li class="dropdown magz-dropdown"><a href="#">My Account <i
                                    class="ion-ios-arrow-right"></i></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown magz-dropdown"><a href="#">My Account <i
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                            ...
                                            class="icon ion-log-out"></i> Logout</a></li>
                            </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <a href="/all" class="btn btn-magz white btn-block">See All <i
                            class="ion-ios-arrow-thin-right"></i></a>
                </div>
